...
g prot_environ_inv = prot_environ/inv
by id: g lag1_prot_environ_inv = L.prot_environ_inv
...
capture quietly reghdfe debt_dummy lag1_prot_environ_inv lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, noabs
eststo debt_environ_noabs

capture quietly reghdfe debt_dummy lag1_prot_environ_inv lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(id)
eststo debt_environ_id

capture quietly reghdfe debt_dummy lag1_prot_environ_inv lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(year)
eststo debt_environ_year

capture quietly eststo: reghdfe debt_dummy lag1_prot_environ_inv lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(id year)
eststo debt_environ_id_year

esttab debt_environ_noabs debt_environ_id debt_environ_year debt_environ_id_year using debt_prot_environ.tex, replace label se ar2 star(* 0.10 ** 0.05 *** 0.01) 
