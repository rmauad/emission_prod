...
esttab using Results_dln_lab_prod.csv, se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) replace drop(*.indust)
...
esttab using Results_dln_cap_prod.tex, replace label se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) drop(*.indust)
esttab using Results_dln_cap_prod.csv, se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) replace drop(*.indust)
...
esttab using Results_dln_tfp.tex, replace label se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) drop(*.indust)
esttab using Results_dln_tfp.csv, se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) replace drop(*.indust)
...
esttab using Results_dln_tfp_hassler.tex, replace label se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01) drop(*.indust)
esttab using Results_dln_tfp_hassler.csv, se stats(fixed N r2, label("Fixed effects")) stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace drop(*.indust)
