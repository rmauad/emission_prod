...
use data/dta/correspondencias_1994-2014_id_uelm.dta, clear
merge m:1 NIC_NOP_2004 using data/dta/Insumo2004_year.dta, keep (3) nogen
...
save data/dta/Insumo2004_year.dta, replace
...
use data/dta/correspondencias_1994-2014_id_uelm.dta, clear
merge m:1 NIC_NOP_1999 using data/dta/Insumo1999_year.dta, keep (3) nogen
tostring new_id, replace
replace new_id = id_uelm
replace new_id = NIC_NOP_2004 if new_id == ""
replace new_id = NIC_NOP_1999 if new_id == ""
drop id_uelm NIC_NOP_1994 NIC_NOP_1999 NIC_NOP_2004 NIC_NOP_2009 NIC_NOP_2014
save data/dta/Insumo1999_year.dta, replace
...
append using data/dta/Insumo1999_year.dta
drop NIC_NOP_2009
