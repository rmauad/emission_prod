...
eststo: xtreg lp_euk_usd c.ep_euk_usd epXhigh epXEME i.year, cluster(ind)
eststo: xtreg lp_euk_usd c.ep_euk_usd epXhigh epXEME i.year, cluster(ind) //repeat just for the format of the table.
...
xtreg lp_euk_usd c.EP_instrument EP_instrumentXhigh_ep_2005 EP_instrumentXEME i.year, cluster(ind)
drop EP_instrument
...
label variable epgXEME   "EP growth * EME"

xtreg lpg epg epgXhigh epgXEME i.year, cluster(ind)
...
gen EPG_instrumentXEME = EPG_instrument*EME
xtreg lpg c.EPG_instrument EPG_instrumentXhigh_ep_2005 EPG_instrumentXEME i.year, cluster(ind)
drop EPG_instrument
drop EPG_instrumentXhigh_ep_2005
drop EPG_instrumentXEME
end
