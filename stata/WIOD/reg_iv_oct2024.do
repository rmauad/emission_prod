...
xtreg atg epg epgXhigh i.year, cluster(ind)
...
xtreg atg_stock c.EPG_instrument EPG_instrumentXhigh_ep_2005 i.year, cluster(ind)
drop EPG_instrument
...
esttab using output/tex/ep_growth_median.tex, replace label se ar2 stats(N) star(* 0.10 ** 0.05 *** 0.01) drop(*.year _cons)
...
xtreg atg_stock c.EPG_instrument EPG_instrumentXhigh_75_ep_2005 i.year, cluster(ind)
drop EPG_instrument
...
xtreg atg_stock c.EPG_instrument EPG_instrumentXhigh_90_ep_2005 i.year, cluster(ind)
drop EPG_instrument
