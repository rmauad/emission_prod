...
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace

* Indep: dln_cap_prod_lag1
capture quietly eststo: reghdfe dln_ener_prod dln_cap_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_cap_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_cap_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_cap_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace

* Indep: dln_tfp_lag1
capture quietly eststo: reghdfe dln_ener_prod dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace

* Indep: dln_tfp_lag1
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 dln_cap_prod_lag1 dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 dln_cap_prod_lag1 dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: reghdfe dln_ener_prod dln_lab_prod_lag1 dln_cap_prod_lag1 dln_tfp_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
