...
// ITAM computer
gl orig "/Users/nuguer/Library/CloudStorage/Dropbox/Documents/2024 Galina Roberto/codes_inegi_20240822 test"

// laptop VN
*gl orig "/Users/vn/Library/CloudStorage/Dropbox/Documents/2024 Galina Roberto/codes_inegi_20240822 test"

cd "${orig}"

use "${orig}/dta/Panel_industries.dta", clear

gl tables "${orig}/output/tables"
...
*** No controls
capture : xi: reghdfe `y' dln_ener_prod_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.ind_2, noabs
if _rc == 0 {
