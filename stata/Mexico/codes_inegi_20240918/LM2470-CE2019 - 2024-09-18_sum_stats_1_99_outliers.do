...
* Remove top and bottom 1% for specified variables
...
esttab using sum_stat_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
* All years
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_75_90_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_75_90_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_75_90_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_75_90_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
* All years
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_90_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_90_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_90_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize ln_ener_prod ln_lab_prod ln_cap_prod ln_tfp ln_emp inv_inc
esttab using sum_stat_90_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
esttab using sum_stat_dln_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_75_90_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_75_90_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_75_90_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_75_90_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_90_all.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_90_2009.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_90_2014.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
estpost summarize dln_ener_prod dln_lab_prod dln_cap_prod dln_tfp
esttab using sum_stat_dln_90_2019.tex, cells("mean(fmt(3)) sd(fmt(3)) min max") ///
noobs title("Summary Statistics") replace
...
***************************************************
***************************************************
* Graph number of establishments by dirty industry
***************************************************
***************************************************
