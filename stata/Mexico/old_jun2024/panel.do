...
local filename = "`path_dta'Insumo`year'_MuestraFicticia.dta"
use "`filename'", clear
gen year = `year'
...
save `path_dta'Insumo`year'_MuestraFicticia_year.dta, replace
}
...
save `path_dta'Insumo2014_2019_MuestraFicticia_year.dta, replace

****************************************************************************
** Appending the Census of all years to create a panel based on new_id.
****************************************************************************

local filename = "`path_dta'Insumo2014_2019_MuestraFicticia_year.dta"
use "`filename'", clear
