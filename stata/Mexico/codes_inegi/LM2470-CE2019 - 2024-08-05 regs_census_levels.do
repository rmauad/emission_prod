...
*** No controls
capture quietly: xi: reghdfe `y' ln_ener_prod_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, noabs
if _rc == 0 {
...
capture quietly: xi: reghdfe `y' ln_ener_prod_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(id)
if _rc == 0 {
...
capture quietly: xi: reghdfe `y' ln_ener_prod_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(year)
if _rc == 0 {
...
capture quietly: xi: reghdfe `y' ln_ener_prod_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(id year)
if _rc == 0 {
...
*** No controls
capture quietly: xi: reghdfe ln_ener_prod `x' ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, noabs
if _rc == 0 {
...
*** Controlling for establishment FE
capture quietly: xi: reghdfe ln_ener_prod `x' ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(id)
if _rc == 0 {
...
*** Controlling for year FE
capture quietly: xi: reghdfe ln_ener_prod `x' ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(year)
if _rc == 0 {
...
*** Controlling for establishment-year FE
capture quietly: xi: reghdfe ln_ener_prod `x' ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.indust, a(id year)
if _rc == 0 {
