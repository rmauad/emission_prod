...
foreach indVar2 in `indVars2' {
    ...
    * Run regressions with different fixed effects specifications
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, noabs
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(new_id)
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(year)
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_debt_dummy lag1_inv_inc, a(new_id year)
...
foreach indVar2 in `indVars2' {
    ...
    * Run regressions with different fixed effects specifications
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_inv_inc, noabs
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_inv_inc, a(new_id)
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_inv_inc, a(year)
    quietly eststo: reghdfe debt_dummy `indVar2' lag1_ln_emp indust_code lag1_inv_inc, a(new_id year)
