...
esttab using Results_dln_lab_prod.csv, se ar2 stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace
...
esttab using Results_dln_lab_prod_factor.tex, replace label se ar2 star(* 0.10 ** 0.05 *** 0.01) 
esttab using Results_dln_lab_prod_factor.csv, se ar2 stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace
...
esttab using Results_dln_cap_prod.tex, replace label se ar2 star(* 0.10 ** 0.05 *** 0.01) 
esttab using Results_dln_cap_prod.csv, se ar2 stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace
...
esttab using Results_dln_tfp.tex, replace label se ar2 star(* 0.10 ** 0.05 *** 0.01) 
esttab using Results_dln_tfp.csv, se ar2 stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace
...
esttab using Results_dln_tfp_hassler.tex, replace label se ar2 star(* 0.10 ** 0.05 *** 0.01) 
esttab using Results_dln_tfp_hassler.csv, se ar2 stats(N r2) star(* 0.10 ** 0.05 *** 0.01) replace
