...
label var ln_ener_prod_lag2 "Energy Productivity (t-2)"
...
// if _rc == 0 {
// outreg2 using "$tables/reg_inst_no_FE_`y'.tex", replace label keep(ln_ener_prod_lag2 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1) addtext(Establishment FE, NO, Year FE, NO)
...
// if _rc == 0 {
// outreg2 using "$tables/reg_inst_no_FE_`y'.tex", append label keep(ln_ener_prod_lag2 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1) addtext(Establishment FE, NO, Year FE, YES)
// }
...
// capture quietly: xi: reghdfe `y' ln_ener_prod_pred_fe_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.ind_2, noabs
// if _rc == 0 {
// outreg2 using "$tables/reg_inst_no_FE_`y'.tex", append label keep(ln_ener_prod_lag2 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1) addtext(Establishment FE, NO, Year FE, NO)
...
// capture quietly: xi: reghdfe `y' ln_ener_prod_pred_fe_lag1 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1 i.ind_2, a(id)
// if _rc == 0 {
// outreg2 using "$tables/reg_inst_`y'.tex", append label keep(ln_ener_prod_lag2 ln_emp_lag1 debt_dummy_lag1 inv_inc_lag1) addtext(Establishment FE, YES, Year FE, NO)
