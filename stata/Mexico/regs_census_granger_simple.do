...
capture quietly eststo: xi: reghdfe dln_lab_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: xi: reghdfe dln_lab_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: xi: reghdfe dln_lab_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: xi: reghdfe dln_lab_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
...
capture quietly eststo: xi: reghdfe dln_cap_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: xi: reghdfe dln_cap_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: xi: reghdfe dln_cap_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: xi: reghdfe dln_cap_prod dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace
...
* Indep: dln_ener_prod_lag1
capture quietly eststo: xi: reghdfe dln_tfp dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: xi: reghdfe dln_tfp dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: xi: reghdfe dln_tfp dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: xi: reghdfe dln_tfp dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace
...
* Indep: dln_ener_prod_lag1
capture quietly eststo: xi: reghdfe dln_tfp_hassler dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, noabs
estadd local fixed "No" , replace
capture quietly eststo: xi: reghdfe dln_tfp_hassler dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id)
estadd local fixed "Entity" , replace
capture quietly eststo: xi: reghdfe dln_tfp_hassler dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(year)
estadd local fixed "Year" , replace
capture quietly eststo: xi: reghdfe dln_tfp_hassler dln_ener_prod_lag1 lag1_ln_emp lag1_debt_dummy lag1_inv_inc i.indust, a(id year)
estadd local fixed "Entity and Year" , replace

// esttab using output/tex/Results_dln_lab_prod.tex, replace label se stats(fixed N r2, label("Fixed effects")) star(* 0.10 ** 0.05 *** 0.01)
